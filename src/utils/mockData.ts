...
export const mockSalesParties: SalesPartyResponse[] = [
    {
        ...
        addresses: [
            ...
            {
                id: 2,
                unitNumber: 'Warehouse 3',
                buildingName: 'Industrial Estate',
                streetOrLandmark: 'Andheri East',
                destination: 'WH',
                city: 'Mumbai',
                state: State.MAHARASHTRA,
                pincode: '400069',
        ...
        items: [
            {
                ...
                serialNumber: 1,
                itemId: 1,
                itemDescription: 'Engine Oil 5W-30 5L',
                quantity: 15,
                rate: 700,
                amount: 10500
            }
        ...
        items: [
            {
                ...
                serialNumber: 1,
                itemId: 3,
                itemDescription: 'Air Filter Premium',
                quantity: 20,
                rate: 800,
                amount: 16000
            }
