                    ...
                    <Space style={{ width: '100%' }} size="large">
                            ...
                            rules={[
                                ...validateAmount(),
                                {
                                    validator: async (_, value) => {
                                        if (!editingPayment && outstandingAmount != null && value > outstandingAmount) {
                                            return Promise.reject(new Error(`Cannot exceed outstanding amount of ${outstandingAmount}`));
                                        }
                        ...
                        >
                            <InputNumber
                                ...
                                prefix="₹"
                                min={0.01}
                                max={!editingPayment && outstandingAmount != null ? outstandingAmount : undefined}
